...
def train_gru_classifier(
    ...
    model = GRUClassifier(input_dim, hidden_dim)
    ...
    for epoch in range(epochs):
        ...
        logger.info("GRU epoch %s loss %.4f", epoch + 1, epoch_loss / len(dataset))
...
__all__ = ["train_gru_classifier", "predict_gru", "GRUClassifier"]

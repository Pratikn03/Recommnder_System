...
def _render_app():  # pragma: no cover - UI code
    ...
    option = st.sidebar.selectbox("Select view", ("All domains", "Fraud", "Cyber", "Behavior", "Vision", "Fusion"))
    ...
    if option == "All domains":
        ...
        show_metrics_csv(EXPERIMENTS_DIR / "fusion" / "metrics" / "metrics.csv", "Fusion Metrics")
